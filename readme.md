> [!WARNING]
> This fork is now archived as the upstream `ly` service for `nixpkgs` now supports what I need
>
> This fork was made to reintroduce the `cmatrix_fg` option lost with the transition to Zig.
...
called _updating_. To update, simply run:
